...
public class BillControl {
    ...
    public static void updateRecord(Bill bill) {
        String sqlUpdate = "update Bills set " +
                "courseID = '"+bill.getCourseId()+"', " +
                "accountID = '"+bill.getAccountId()+"', " +
                "buyAt = '"+bill.getBuyAt()+"'" +
                "where billID = '"+bill.getId()+"'";
        try {
    ...
    // Hàm xóa một bản ghi trong của bảng Bills dựa vào id trong DataBase
    public static void deleteRecord(String id) {
        String sqlDelete = "delete Bills where billID = '"+id+"'";
        try {
