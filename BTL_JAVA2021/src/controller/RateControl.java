...
public class RateControl {
    ...
    // Hàm xóa một bản ghi trong của bảng Rates dựa vào id trong DataBase
    ...
    // Hàm tìm một bản ghi trong của bảng Rates dựa vào id trong DataBase
    ...
    public static int rateQuanty(String courseID) {
        String sqlSelect = "select count(rateValue) from Rates " +
                " where courseID = '"+courseID+"'";
        try {
            ResultSet resultSet = JDBC.statement.executeQuery(sqlSelect);
            if(resultSet.next()) {
